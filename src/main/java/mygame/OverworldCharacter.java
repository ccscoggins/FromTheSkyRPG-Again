...
public class OverworldCharacter extends CharacterControl implements ActionListener{
    private volatile OverworldAppState oas;
    ...
    private final float INTERACT_DISTANCE = 2;
    private Vector3f interactVector;
     ...
     * @param playerModel 
     */
    public OverworldCharacter(Spatial playerModel, OverworldAppState oas){
    ...
    public void update(float tpf){
        ...
        interactVector = this.getViewDirection(interactVector);
        interactVector.multLocal(INTERACT_DISTANCE);
        
    }
    
    /**
     * Get whether the player is walking or not.  Used for ticking random encounters.
     * @return 
     */
