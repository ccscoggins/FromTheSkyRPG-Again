...
public class StatusMessage extends MyBaseAppState implements ActionListener {
    ...
    private static final float DEFAULT_DISPLAY_SPEED = 0.5f;
    ...
    protected void initialize(Application arg0) {
        ...
        System.out.println("Status offset: " + statusOffset);
    }
    ...
    public void update(float tpf){
        ...
        //System.out.println("fully displayed: " + fullyDisplayed + "; advance: " + advance);
